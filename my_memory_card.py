...
def next_question():
    ...
    q = list_q[question_с] # взяли вопрос
    ask(q) # спросили
...
list_q.append(Question('Лишь утратив все до конца мы обретаем...', 'свободу', 'силу', 'честь', 'печеньку'))
list_q.append(Question('5+5','10','5','6','7'))
list_q.append(Question('Столица России','Москва','ПИтер','Дербент','Ижевск'))
list_q.append(Question('самая маленькая частица','кварк','протон','нейтрон','мозги рашида'))
list_q.append(Question('10-1','1','3','100','999'))
list_q.append(Question('падлежащее + сказуемое','граматическая основа','пистолет','причастный оборот','дееепричастный оборот'))
...
Question = QLabel('Самый сложный вопрос в мире!')# текст вопроса
